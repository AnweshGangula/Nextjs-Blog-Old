---
title: "Github Flavored Markdown (GFMD) - Sample"
layout: "post"
publishedOn: 2021-08-12T09:15:00-0400
isPublished: true
seoTitle: Sample Github Flavored Markdown (GFMD) with all types of text
abstract: This post is to test all types of markdown content.
---

Reference: https://gist.github.com/stevenyap/7038119
...
- To specify a link on a text, do this:
  ...
  ```
  TODO: rehype prism doesn't work without language
